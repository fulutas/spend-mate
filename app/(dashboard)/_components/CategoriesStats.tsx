...
function CategoriesStats({ userSettings, from, to }: Props) {
  ...
  return (
    <div className='flex w-full flex-wrap gap-2 md:flex-nowrap mt-5'>
...
function CategoriesCard({ data, type, formatter }: { type: TransactionType; formatter: Intl.NumberFormat; data: GetCategoriesStatsResponseType }) {
